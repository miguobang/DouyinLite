...
const ProjectCommonFunction = function () {
  ...
  let _this = this
  this.keyList = [WATCHED_RANK, KNOWN_CHECK, SIGN_CHECK]
  ...
  this.setTaskArgs = function (args) {
    this.updateRuntimeStorage(TASK_ARGS, JSON.stringify(args))
  }

  this.getTaskArgs = function () {
    return this.getFullTimeRuntimeStorage(TASK_ARGS)
  }
