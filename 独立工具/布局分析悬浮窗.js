...
let { winBase64 } = require('./floaty/data.js')
//menu菜单数据可自行修改
  ...
  switch (view._name.text()) {
    ...
    case "截":
      ...
      threads.start(function () {
        ...
        ui.run(function () {
          engines.execScriptFile(mainScriptPath + "/独立工具/获取当前页面的布局信息.js", { path: mainScriptPath + "/独立工具/", arguments: { immediate: true, capture: true } })
        })
      })
      break;
    case "啾":
